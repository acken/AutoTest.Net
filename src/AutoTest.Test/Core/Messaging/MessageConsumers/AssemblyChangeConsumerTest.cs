...
namespace AutoTest.Test
{
	...
	public class AssemblyChangeConsumerTest
	{
		...
		public void Should_run_tests()
		{
            ...
            _preProcessor.Stub(p => p.PreProcess(null)).IgnoreArguments().Return(new PreProcessedTesRuns(new RunInfo[] { new RunInfo(new AutoTest.Core.Caching.Projects.Project("", null)) })); 
